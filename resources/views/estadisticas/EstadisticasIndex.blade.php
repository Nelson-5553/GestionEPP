<x-app-layout>
   ...
   <div class="flex flex-col lg:flex-row justify-between items-center mt-5">
    ...
    <div class="flex flex-col md:flex-row gap-5">
        <a href="" class="flex items-center w-auto bg-emerald-500 text-white text-md p-2 rounded-md gap-2">
        ...
        <a href="{{route('download.report')}}" class="flex items-center w-auto bg-red-500 text-white text-md p-2 rounded-md gap-2">
