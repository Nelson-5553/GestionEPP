<x-app-layout>
    <div class=" max-w-7xl mx-auto py-12 px-6 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-12">
            <div class="rounded-lg sm:col-span-1 md:col-span-1 lg:col-span-2" id="chart"
                data-categories='@json($categories)' data-solicitudes='@json($solicitudesData)'
                data-entregas='@json($entregasData)'>
            </div>
