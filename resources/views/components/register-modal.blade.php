...
<div x-data="{ infoModalIsOpen: false }">
    <button x-on:click="infoModalIsOpen = true" type="button" class="sm:w-36 w-44 border border-[#5A6ACF] whitespace-nowrap rounded-md bg-[#5A6ACF] px-4 py-2 text-center text-sm font-medium tracking-wide text-white transition hover:opacity-75 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#5A6ACF] active:opacity-100 active:outline-offset-0">Registrar {{ $name }}</button>
