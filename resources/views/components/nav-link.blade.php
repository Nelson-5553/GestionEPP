...
$classes = ($active ?? false)
            ? 'flex items-center rounded-sm gap-2 bg-black/10 px-2 py-1.5 text-sm font-medium text-indigo-500 underline-offset-2 focus-visible:underline focus:outline-hidden dark:bg-white/10 dark:text-indigo-400'
