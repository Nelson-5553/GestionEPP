        ...
        <div class="mt-8 bg-[#F1F2F7] dark:bg-neutral-800 p-6 rounded-lg">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
               <div class="text-gray-900 dark:text-gray-200">
                    <p class="font-semibold">Nombre del Epp
                    <p class="text-gray-700 dark:text-gray-300">{{$epp->name}}</p>
                </div>
                <div class="text-gray-900 dark:text-gray-200">
                    <p class="font-semibold">Canatidad</p>
                    <p class="text-gray-700 dark:text-gray-300">{{$epp->cantidad}}</p>
                </div>
                <div class="text-gray-900 dark:text-gray-200">
                    <p class="font-semibold">Tipo de unidad</p>
                    <p class="text-gray-700 dark:text-gray-300">{{$epp->unity}}</p>
                </div>
                <div class="col-span-2 text-gray-900 dark:text-gray-200">
                    <p class="font-semibold">Descripción:</p>
                    <p class="text-gray-700 dark:text-gray-300">{{$epp->description}}</p>
                </div>
            </div>
