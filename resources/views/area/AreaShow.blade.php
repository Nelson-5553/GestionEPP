        ...
        <div class="mt-8 bg-[#F1F2F7] dark:bg-neutral-800 p-6 rounded-lg">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="text-gray-900 dark:text-gray-200">
                    <p class="font-semibold">Nombre del Área:</p>
                    <p class="text-gray-700 dark:text-gray-300">{{ $area->name }}</p>
                </div>
                <div class="text-gray-900 dark:text-gray-200">
                    <p class="font-semibold">Sede:</p>
                    <p class="text-gray-700 dark:text-gray-300">{{ $area->sede->name }}</p>
                </div>
                <div class="col-span-2 text-gray-900 dark:text-gray-200">
                    <p class="font-semibold">Descripción:</p>
                    <p class="text-gray-700 dark:text-gray-300">{{ $area->description }}</p>
                </div>
            </div>
