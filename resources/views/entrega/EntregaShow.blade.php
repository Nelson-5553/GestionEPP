<x-app-layout>
    <div class="max-w-7xl mx-auto py-12 px-6 lg:px-8">
        ...
        <div
            class="flex flex-col sm:flex-row sm:justify-between bg-[#f9f9fa] dark:bg-neutral-800 border-2 border-gray-300 dark:border-gray-600 w-full rounded-t-lg p-3 sm:p-4 mt-6 sm:mt-8">
            <h1 class="text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-200">Información de Entrega</h1>
            <span
                class="w-fit inline-flex overflow-hidden rounded-full border bg-white text-xs sm:text-sm font-medium dark:bg-neutral-950 {{ $clase }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2  gap-8">
                ...
                <div class="flex flex-col text-gray-900 dark:text-gray-200 col-span-1 md:col-span-2">
                    ...
                    <div class="bg-slate-300/50 dark:bg-slate-600/50 rounded-lg p-4 mt-4">
                        <p class="text-sm break-words">{{ $entrega->observations ?? 'No hay observación disponible' }}</p>
                    </div>
                </div>
            </div>
            ...
            @else
                ...
                <form action="{{ route('entrega.update', $entrega) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                        ...
                        <div>
                            <button type="submit"
                                class="flex flex-row justify-center w-full mt-1 py-2 px-6 border rounded-lg bg-blue-600 text-white hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 gap-2.5">
