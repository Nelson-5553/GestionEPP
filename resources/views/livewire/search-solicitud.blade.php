    ...
    @hasanyrole(['admin', 'supervisor'])
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
            <div wire:click="setEstado(null)"
                ...
                <p class="ml-1.5">{{ \App\Models\Solicitud::count() }}</p>
            </div>
            ...
            <div wire:click="setEstado('Aprobado')"
              ...
              <div class="flex flex-row items-center gap-2">
                ...
                <p class="ml-1.5">{{ \App\Models\Solicitud::where('state', 'Aprobado')->count() }}</p>
            </div>
            ...
            <div wire:click="setEstado('Rechazado')"
                ...
                <p class="ml-1.5">{{ \App\Models\Solicitud::where('state', 'Rechazado')->count() }}</p>
            </div>
            ...
            <div wire:click="setEstado('Pendiente')"
                ...
                <p class="ml-1.5">{{ \App\Models\Solicitud::where('state', 'Pendiente')->count() }}</p>
            </div>
        </div>
    @endhasanyrole
