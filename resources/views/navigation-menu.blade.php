<nav x-data="{ open: false }" class="bg-slate-100/10 border-b border-gray-100 dark:border-neutral-900 dark:bg-gray-950 shadow-lg">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="relative my-4 flex items-center gap-2">
                    ...
                    <button class="rounded-md  p-2 md:hidden text-gray-500  dark:text-white"
                ...
                <!-- Navigation Links -->
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex prose dark:prose-invert">
